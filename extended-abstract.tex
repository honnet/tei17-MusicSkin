...
\author{%
    ...
    \setlength\fboxsep{0.05\columnwidth}    % margin: 5% / 95% for the pic:
    \fbox{ \includegraphics[width=0.95\columnwidth]{figures/sigchi-logo} }
    \fbox{ Let's put a picture here to quickly illustrate the project.  }
}
