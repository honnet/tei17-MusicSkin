...
\author{%
    ...
    \makebox(-30,-175){ \includegraphics[width=1.08\columnwidth]{figures/touch} }
    \alignauthor{~}
    \alignauthor{~}
    \alignauthor{%
    ...
    \alignauthor{%
        ...
        \affaddr{DataPaulette} \\
        \affaddr{Paris, France} \\
        \email{cedric@datapaulette.org} \\
        \textbf{~} \\
    }
    \alignauthor{~}
    \alignauthor{%
        \textbf{Paul Strohmeier}\\
         \affaddr{Human Centered Computing} \\
        \affaddr{University of Copenhagen} \\
        \affaddr{Denmark} \\
        \email{p.strohmeier@di.ku.dk}
    }
    % caption of the picture
    \makebox(-80,-50){ \textbf{Figure 0:} Visualization of the Musical Skin being touched.}
}
...
We present an art installation using Musical Skins: soft, malleable fabric interfaces that users can freely manipulate to play music. As seen in fig. \ref{fig:foldraped}, Musical Skins can be draped over objects, worn, folded, pulled, bent and squished to produce sound. If draped over the body - as a scarf, cape, skirt, bracelet - interesting feedback modalities emerge. The users feel the tactile properties of the fabric in their fingertips, while at the same time feeling the pressure and taps of the fingers through their body. Additionally percussive hits, tones and pads fill the room with sound, leading to a multisensory experience involving the entire body.
